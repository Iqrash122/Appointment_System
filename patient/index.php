            ...
            <table class="menu-container" border="0">
                ...
                <tr class="menu-row">
                    <td class="menu-btn menu-icon-doctor">
                        <a href="doctors.php" class="non-style-link-menu"><div><p class="menu-text">All Lawyers</p></a></div>
                    </td>
                </tr>
                    ...
                    <tr>
                        <td >
                            ...
                            <p>Haven't any idea about lawyers? no problem let's jumping to 
                                <a href="doctors.php" class="non-style-link"><b>"All Lawyers"</b></a> section or 
                            ...
                            <form action="schedule.php" method="post" style="display: flex">
                                ...
                                <input type="search" name="search" class="input-text " placeholder="Search Lawyer and We will Find The Session Available" list="doctors" style="width:45%;">&nbsp;&nbsp;
